  ...
  Future<void> _pickAndUploadProfileImage() async {
    ...
    try {
      ...
      if (url != null) {
        ...
        if (user != null) {
          final currentProfile = await _userService.getUserProfileFuture(user.uid);
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Column(
              children: [
                // Custom app bar with standard height and SafeArea
                SafeArea(
                  top: true,
                  bottom: false,
                  child: Container(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            package: null, // Ensures it uses the local asset
                          ),
                        ),
                        const Spacer(),
                        if (_selectedIndex == 3)
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsets.only(top: 0), // No extra top padding
                                          ...
                                          onPressed: () async {
                                            ...
                                            try {
                                              ...
                                              if (mounted) {
                                                ...
                                                ScaffoldMessenger.of(context).showSnackBar(
                                                  const SnackBar(content: Text('Account and all recipes deleted.')),
                                                );
                                              }
                                            } catch (e) {
                                              if (mounted) {
                                ...
                                if (profile != null && profile.savedRecipes.isNotEmpty) ...[
                                  ...
                                  StreamBuilder<List<Recipe>>(
                                    stream: _recipeService
                                        .getRecipesByIds(profile.savedRecipes),
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState ==
                                          ConnectionState.waiting) {
                                        return const Center(
